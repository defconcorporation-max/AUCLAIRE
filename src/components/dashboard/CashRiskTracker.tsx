    ...
    return (
        <Card className="glass-card border-l-4 border-l-red-500/50 overflow-hidden relative">
            <CardHeader className="py-4 border-b border-white/5">
                ...
                <CardDescription className="text-[10px] uppercase tracking-widest text-red-500/70 font-medium">Flash: Projets en Déficit de Cash</CardDescription>
            </CardHeader>
            <CardContent className="p-0">
                {highRiskProjects.length === 0 ? (
                    <div className="p-8 flex flex-col items-center justify-center text-center">
                        <CheckCircle2 className="w-10 h-10 text-green-500 mb-2 opacity-30" />
                        <p className="text-xs uppercase tracking-widest text-green-500/70 font-bold">Zéro Déficit</p>
                        <p className="text-[10px] text-muted-foreground mt-1">Toutes les productions sont couvertes par les acomptes.</p>
                    </div>
                ) : (
