...
const Sidebar = ({ role, profile, signOut, setIsMobileOpen }: { role: any, profile: any, signOut: any, setIsMobileOpen: (v: boolean) => void }) => (
    <div className="flex flex-col h-full bg-black/40 backdrop-blur-xl border-r border-white/5 text-gray-300">
        <div className="p-8">
...
export default function CRMLayout({ children }: { children?: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans selection:bg-luxury-gold/30 selection:text-luxury-gold">
            {/* Mobile Header */}
            <div className="lg:hidden flex items-center justify-between p-4 border-b border-white/5 bg-black/60 backdrop-blur-lg fixed w-full z-50">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Sheet open={isMobileOpen} onOpenChange={setIsMobileOpen}>
                        ...
                        <SheetContent side="left" className="p-0 border-r-white/5 bg-[#050505]/95 backdrop-blur-xl">
            ...
            <div className="flex h-screen overflow-hidden lg:pt-0 pt-[73px]">
                ...
                <div className="flex-1 flex flex-col min-w-0 relative">
                    ...
                    <header className="hidden lg:flex items-center justify-end px-8 py-4 z-10">
                        <div className="flex items-center gap-4 bg-black/40 backdrop-blur-md border border-white/5 rounded-full px-2 py-1 shadow-sm">
                            <NotificationBell />
                        </div>
                    </header>
