...
import { Lock, X, ChevronDown, ChevronRight, CheckCircle2, Search, BrainCircuit, Target } from 'lucide-react';
...
function FormationContent() {
    ...
    const SectionHeader = ({ id, icon: Icon, title, emoji }: { id: string, icon?: any, title: string, emoji?: string }) => (
        <button
        ...
        >
            ...
            <div className="p-2 rounded-full bg-white/5 group-hover:bg-[#D2B57B]/20 transition-colors">
                {expandedSections[id] ? <ChevronDown className="w-5 h-5 text-gray-400 group-hover:text-[#D2B57B]" /> : <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-[#D2B57B]" />}
            </div>
        </button>
    );
            ...
            <div className="max-w-6xl mx-auto px-6 py-16 relative z-10">
                ...
                <header className="text-center mb-16 border-b border-white/10 pb-16">
                    ...
                    <p className="text-gray-400 max-w-2xl mx-auto text-lg md:text-xl leading-relaxed font-serif italic">
                        Bague de Fiançailles — Le guide ultime d'accompagnement et de vente.
                    </p>
                </header>

                {/* OBJECTIFS */}
                <section className="mb-16">
                    <SectionHeader id="objectives" emoji="⭐" title="Objectifs du Document" />
                ...
                <section className="mb-16">
                    <SectionHeader id="cuts" emoji="💎" title="Guide des Coupes (Diamants)" />
                    {expandedSections.cuts && (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-top-4">
                            ...
                            {/* Pear / Radiant / Marquise / Asscher could be added here following the exact same pattern */}
                            {/* Pear */}
                            <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-[#D2B57B]/50 transition-colors shadow-lg">
                                <div className="flex h-32 overflow-hidden bg-black/50">
                ...
                {/* SECTION OR JAUNE */}
                <section className="mb-16">
                    <SectionHeader id="gold" emoji="✨" title="Métaux : Différence Visuelle Or Jaune" />
                ...
                <section className="mb-16">
                    <SectionHeader id="consultation" emoji="🗣️" title="Diagnostic & Consultation Patient" />
                ...
                {/* PROCESSUS 12 PHASES */}
                <section className="mb-16">
                    <SectionHeader id="process" emoji="🧭" title="Processus & Accompagnement (12 Phases)" />
                ...
                <section className="mb-10">
                    <SectionHeader id="rules" emoji="📜" title="Règles d'Or Auclaire" />
